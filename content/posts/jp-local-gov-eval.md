...
評価対象 | 次の三種類のいずれかの値を取ります。値ごとに 0 ~ 1 の範囲のスコア値に変換されます。<ul><li>事業 → 事務事業評価シートが公開されている → 1.0</li><li>施策 → 事務事業評価シートの代わりに施策評価シートが公開されている → 0.5</li><li>なし → なにも公開されていない → 0</li></ul>
...
様式分類 | 様式点による４種類の分類です。<ul><li>様式点 = 1 → 標準</li><li>様式点 ≧ 0.8 → 準標準</li><li>様式点 ≧ 0.5 → 参考</li><li>様式点 ≧ 0.5 → 参考</li><li>それ以外 → -</li></ul>
